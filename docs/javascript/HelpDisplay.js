...
class HelpDisplay extends AuxiliaryDisplay {
    ...
    constructor(buttonContainer, buttonInfo, parentContainer, saveRestoreContainers) {
        ...
        <img src="${Const.HELP_IMAGE_URL}/Help01.v1.jpg" width="350px"/>
        <p>
        ...
        <img src="${Const.HELP_IMAGE_URL}/Help02.v1.jpg" width="350px"/>
        <p>
        ...
        <img src="${Const.HELP_IMAGE_URL}/Help03.v1.jpg" width="350px"/>
        <p>
        ...
        <img src="${Const.HELP_IMAGE_URL}/Help04.v1.jpg" width="350px"/>
        <p>
        ...
        <img src="${Const.HELP_IMAGE_URL}/Help05.v1.jpg" width="350px"/>
        <p>
        ...
        <img src="${Const.HELP_IMAGE_URL}/Help06.v1.jpg" width="350px"/>
        <p>
        Here, we need to add another letter.
        We'll tap the first '+'.
        </p>

        <img src="${Const.HELP_IMAGE_URL}/Help07.v1.jpg" width="350px"/>
        <p>
        Again we see a letter with a '?'; we tap on the 'A' tile to
        chain from HEAD to AHEAD.
        </p>

        <img src="${Const.HELP_IMAGE_URL}/Help08.v1.jpg" width="350px"/>
        <p>
        ...
        <img src="${Const.HELP_IMAGE_URL}/Help09.v1.jpg" width="350px"/>
        <p>
        ...
        <img src="${Const.HELP_IMAGE_URL}/Help10.v1.jpg" width="350px"/>
        <p>
        ...
        <img src="${Const.HELP_IMAGE_URL}/Help11.v1.jpg" width="350px"/>
        <p>
        We removed the 'R' to make HAM, but now we're stuck!
        Tap "Show Word" to get unstuck.
        </p>

        <img src="${Const.HELP_IMAGE_URL}/Help12.v1.jpg" width="350px"/>
        <p>
        The gray letters indicate you got some help.
        Now we finish off the game as we did before.
        </p>

        <img src="${Const.HELP_IMAGE_URL}/Help13.v1.jpg" width="350px"/>
        <p>
        ...
        <img src="${Const.HELP_IMAGE_URL}/Help14.v1.jpg" width="350px"/>
        <p>
        </p>
        <img src="${Const.HELP_IMAGE_URL}/Help15.v1.jpg" width="350px"/>
        <p>
        </p>
        <img src="${Const.HELP_IMAGE_URL}/Help16.v1.jpg" width="350px"/>

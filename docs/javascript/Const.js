...
export const DAILY_GAMES_URL   = "https:/docs/resources/DailyGames";

export const DAILY_GAMES = await fetch(DAILY_GAMES_URL)
    .then(resp => resp.text())
    .then(text => text.split("\n"))
    .then(lines => lines.map((line)=>line.toUpperCase().split(/\s+/)))
